# payload-bootstrap Specification

## Purpose

Scaffold a Payload CMS 3 backend project using the official `create-payload-app` blank template with PostgreSQL, ready for multi-tenant configuration.
